...
const CHAT_STORAGE_KEY = "technology";
...
export function createTechnologyAgentController(root: ParentNode): () => void {
  ...
  let sessionCategory: AgentPromptCategory | null = TECHNOLOGY_AGENT_CATEGORY;
  ...
  function applyCategoryPreset(prompt: string) {
    sessionCategory = TECHNOLOGY_AGENT_CATEGORY;
  ...
  const chatSession = setupAgentChatSession({
    ...
    defaultCategory: TECHNOLOGY_AGENT_CATEGORY,
    chatMessages,
