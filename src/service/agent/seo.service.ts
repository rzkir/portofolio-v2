...
export const SEO_AGENT_CATEGORY: AgentPromptCategory = "seo";
const CHAT_STORAGE_KEY = "seo";

export const SEO_CATEGORY_CARDS: AgentCategoryCard[] = [
  {
    title: "Keyword Research",
    categoryLabel: "SEO · Research",
    description:
      "Temukan keyword dengan potensi traffic tinggi dan kompetisi rendah untuk niche Anda.",
    category: "seo",
    prompt:
      "Lakukan keyword research untuk website saya. Berikan daftar keyword utama, long-tail, dan search intent masing-masing.",
  },
  {
    title: "On-Page Optimization",
    categoryLabel: "SEO · On-Page",
    description:
      "Optimasi meta title, description, heading structure, dan internal linking.",
    category: "seo",
    prompt:
      "Audit dan optimasi on-page SEO untuk halaman saya. Berikan rekomendasi meta tags, heading structure, dan internal linking.",
  },
  {
    title: "Content Strategy",
    categoryLabel: "SEO · Content",
    description:
      "Rancang kalender konten dan topik artikel yang mendukung ranking organik.",
    category: "seo",
    prompt:
      "Buatkan strategi konten SEO 3 bulan untuk website saya, termasuk topik artikel, target keyword, dan struktur pillar-cluster.",
  },
  {
    title: "Technical SEO",
    categoryLabel: "SEO · Technical",
    description:
      "Periksa kecepatan, crawlability, schema markup, dan mobile-friendliness.",
    category: "seo",
    prompt:
      "Buatkan checklist technical SEO untuk website saya: Core Web Vitals, sitemap, robots.txt, schema markup, dan mobile optimization.",
  },
];
...
export function createSeoAgentController(root: ParentNode): () => void {
  ...
  let sessionCategory: AgentPromptCategory | null = SEO_AGENT_CATEGORY;
  ...
  function applyCategoryPreset(prompt: string) {
    sessionCategory = SEO_AGENT_CATEGORY;
    if (categoryInput) categoryInput.value = SEO_AGENT_CATEGORY;
    if (!input) return;
  ...
  const chatSession = setupAgentChatSession({
    ...
    defaultCategory: SEO_AGENT_CATEGORY,
    chatMessages,
...
export function bindSeoAgent(root: ParentNode = document): void {
  mountSeoAgent(root);
  document.addEventListener("astro:page-load", () => mountSeoAgent(document));
}
